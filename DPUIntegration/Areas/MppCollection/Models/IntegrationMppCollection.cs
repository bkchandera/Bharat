...
{
    [Table("integration_mpp_collection")]
    //[History("integration_mpp_collection_history")]
    public class IntegrationMppCollection : BaseModel
    {
        [Key]
        [ExplicitKey]
        public int mpp_collection_code { get; set; }
    ...
    public class IntegrationMppCollectionValidator : AbstractValidator<IntegrationMppCollection>
    {
        public IntegrationMppCollectionValidator()
        {
            QueryParam Query = new QueryParam
            {
                Fields = "mpp_collection_code",
                Table = "integration_mpp_collection",
                Where = new List<ConditionParameter>
                {
                     ...
                     new ConditionParameter{PropertyName="farmer_code"},
            ...
            RuleFor(d => d.collection_date).Require().Unique(Query)
                .WithMessage("collection_already_exist");
